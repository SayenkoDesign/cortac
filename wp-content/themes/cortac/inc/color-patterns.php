 ...
 */
function cortac_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Cortac default saturation level.
	 *
	 * @since Cortac 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'cortac_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.cortac-front-page) .entry-title,
...
.colors-custom .cortac-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.cortac-front-page .panel-content .recent-posts article,
...
.colors-custom.cortac-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Cortac custom colors CSS.
	 *
	 * @since Cortac 1.0
	 *
	 ...
	 */
	return apply_filters( 'cortac_custom_colors_css', $css, $hue, $saturation );
}
